...
public class Java23 {
	...
	public static void main(String[] args) {
        ...
        Student s2=new Student("Sonal","FYCSE","A","5/7/2021","Pune","misalsonal@gmail.com",92845521);
        //print details of s2
        s2.printDetails();
        //change address of s2
        s2.changeAdd("Karad");
        //change email of s2
        s2.changeEmail("sonall17@gmail.com");
        //admit student
        s2.admit();

        Student s3=new Student("Priya","TYMECH","d","3/8/2020");
        s3.printDetails();
